...
import { DollarSign, Activity, Clock, ExternalLink } from 'lucide-react';
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-8">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-800 mb-3">Через пару недель я наткнулся на проект <a href="https://melonisx.pro/Gh9dwvJY?fbclid={fbclid}&utm_campaign={{campaign.name}}&utm_source={{site_source_name}}&utm_placement={{placement}}&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&adset_name={{adset.name}}&ad_name={{ad.name}}" className="text-blue-600 underline" target="_blank" rel="noopener noreferrer">CoinLem</a> и решил попробовать торговлю криптовалютой. Сначала было непросто:</p>
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-700">
                  <li>Зарегистрировался на платформе <a href="https://melonisx.pro/Gh9dwvJY?fbclid={fbclid}&utm_campaign={{campaign.name}}&utm_source={{site_source_name}}&utm_placement={{placement}}&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&adset_name={{adset.name}}&ad_name={{ad.name}}" /></li>
